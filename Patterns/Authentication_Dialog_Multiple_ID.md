...
##More Details
- **Company Branding on Azure AD Sign-in** - Azure AD provides developers the capability adding a brand to their sign-in experience for a consistent look. [Learn More](https://azure.microsoft.com/en-us/documentation/articles/active-directory-branding-guidelines/#visual-guidance-for-sign-in).
