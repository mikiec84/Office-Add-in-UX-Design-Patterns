...
##More Details
- **Company Branding on Azure AD Sign-in** - Azure AD provides developers the capability of branding their sign-in experience. [Learn More](https://azure.microsoft.com/en-us/documentation/articles/active-directory-branding-guidelines/#visual-guidance-for-sign-in).
